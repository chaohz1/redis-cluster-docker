...
## 方案2
docker run -it -d -p 6379:6380 -p 16379:16379 --net redis-net -v ${workdir}/application.yml:/apps/application.yml --name ${container_name} camellia-redis-proxy:1.2.11f java -XX:+UseG1GC -Xms1024m -Xmx2048m -XX:+UseContainerSupport -Dspring.config.location=/apps/application.yml -jar camellia-redis-proxy.jar